...
// QQ DevTools may expose wx for backward compat — force platform before detection
_g.__platform = "qq";
...
var _api = PlatformRuntime.requirePlatform("qq", "QQ entrypoint");
...
loader.load().catch((error) => console.error("[Game] QQ startup failed:", error));
