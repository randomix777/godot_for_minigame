...
// Alipay DevTools may expose wx for backward compat — force platform before detection
_g.__platform = "alipay";
...
var _api = PlatformRuntime.requirePlatform("alipay", "Alipay entrypoint");
...
loader.load().catch((error) => console.error("[Game] Alipay startup failed:", error));
