...
// Kuaishou DevTools may expose wx for backward compat — force platform before detection
_g.__platform = "kuaishou";
...
var _api = PlatformRuntime.requirePlatform("kuaishou", "Kuaishou entrypoint");
...
loader.load().catch((error) => console.error("[Game] Kuaishou startup failed:", error));
