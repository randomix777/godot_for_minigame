...
// Baidu DevTools may expose wx for backward compat — force platform before detection
_g.__platform = "baidu";
...
var _api = PlatformRuntime.requirePlatform("baidu", "Baidu entrypoint");
...
loader.load().catch((error) => console.error("[Game] Baidu startup failed:", error));
