...
// Douyin DevTools exposes wx for backward compat — force platform before detection
_g.__platform = "douyin";
...
var _api = PlatformRuntime.requirePlatform("douyin", "Douyin entrypoint");
...
loader.load().catch((error) => console.error("[Game] Douyin startup failed:", error));
